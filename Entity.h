...
enum EntityType { PLATFORM, LANDING, ROCKET, ENEMY  };
...
private:
    ...
    std::string m_display_message_reset;
...
public:
    ...
    void face_left() { m_scale.x = -abs(m_scale.x); }
    void face_right() { m_scale.x = abs(m_scale.x); }
    ...
    void accelerate_left() { m_acceleration.x = -m_speed; face_left(); };
    void accelerate_right() { m_acceleration.x = m_speed; face_right(); };
    ...
    bool const get_can_move() const { return m_can_move; }
    ...
    std::string const get_display_message() const { return m_display_message; }
    std::string const get_display_message_reset() const { return m_display_message_reset; }
    ...
    void const set_display_message(std::string new_msg) { m_display_message = new_msg; }
    void const set_display_message_reset(std::string new_msg) { m_display_message_reset = new_msg; }
    ...
    void const set_can_move(bool new_can_move) { m_can_move = new_can_move; }
